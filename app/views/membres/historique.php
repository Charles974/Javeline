<div class="page-header mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="mb-0">Historique — <?= htmlspecialchars($membre['nom'] . ' ' . $membre['prenom']) ?></h1>
        <p class="text-muted mb-0 small">Licence n° <?= htmlspecialchars($membre['numero_licence']) ?></p>
    </div>
    <a href="<?= APP_URL ?>/membres" class="btn btn-outline-secondary btn-sm" aria-label="Retour à la liste des membres">
        ← Membres
    </a>
</div>
...
<div class="card liste-card">
    ...
    <div class="card-body p-0">
        <?php if (empty($challenges)): ?>
            <p class="liste-vide">Ce membre n'a encore participé à aucun challenge.</p>
        <?php else: ?>
            <div class="table-responsive">
                <table class="table table-hover membres-table" aria-label="Historique des challenges du membre">
                    <thead>
                        <tr>
